...
option_list <- list(
    ...
    make_option(c("-r", "--inputFolder"), type="character", default="01-CleanedReads",
                ...
                dest="inputFolder"),    
    make_option(c("-b", "--mappingFolder"), type="character", default='02-MappedReads_STAR',
                help="Directory where to store the mapping results [default %default]",
                dest="mappingFolder"),
    make_option(c("-e", "--extractFolder"), type="character", default="03-UnmappedReads_STAR",
                help="Directory where to store the ummapping reads [default %default]",
                dest="extractedFolder"),
    make_option(c('-E', '--countFolder'), type = 'character', default = '04-GeneCounts_STAR',
